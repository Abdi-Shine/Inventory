  ...
  <div class="breadcrumb-wrapper light-bg" style="padding: 40px 0;">
    <div class="container">
      ...
      <div class="breadcrumb-content">
        <h1 class="breadcrumb-title pb-0" style="font-size: 35px; margin-bottom: 5px;">{{ $service->title }}</h1>
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="lonyo-content-thumb2" data-aos="fade-right" data-aos-duration="700">
            <img src="{{ asset($service->image) }}" alt="{{ $service->title }}" style="width: 100%; max-width: 526px; height: 550px; object-fit: cover; border-radius: 10px;">
          </div>
        </div>
        <div class="col-lg-7 d-flex align-items-center">
          <div class="lonyo-default-content pl-50" data-aos="fade-up" data-aos-duration="700">
            <h2 style="margin-bottom: 20px; font-size: 32px; font-weight: 700; color: #004161;">{{ $service->title }}</h2>
            <div class="data">
