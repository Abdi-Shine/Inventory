                        ...
                        <form method="post" action="{{ route('update.multi.image') }}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id" value="{{ $multiImage->id }}">
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="title" class="form-control" type="text" value="{{ $multiImage->title }}">
                                </div>
                            </div>
                            <!-- end row -->
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="description" class="form-control" type="text" value="{{ $multiImage->description }}">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                              ...
                              <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ asset($multiImage->image) }}" alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
