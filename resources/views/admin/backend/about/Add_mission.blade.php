                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="long_title" class="form-control" type="text" value="{{ $about->long_title }}"  id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="long_description" class="form-control" rows="5">{{ $about->long_description }}</textarea>
                                </div>
                            </div>
                            <!-- end row -->
