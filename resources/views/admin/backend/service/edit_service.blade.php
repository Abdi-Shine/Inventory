...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Edit Service Page </h4> <br><br>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="title" value="{{ $service->title }}" id="example-text-input" required>
                </div>
            </div>
            <!-- end row -->
            ...
            <!-- end row -->
             ...
             <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea id="elm1" name="long_description">{{ $service->long_description }}</textarea>
                </div>
            </div>
            <!-- end row -->
           ...
           <input name="image" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ asset($service->image) }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
