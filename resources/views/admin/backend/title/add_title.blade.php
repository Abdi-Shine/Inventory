                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="description1" name="description1" value="{{ old('description1') }}">
                                        @error('description1')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="description3" name="description3" value="{{ old('description3') }}">
                                        @error('description3')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title4" name="title4" value="{{ old('title4') }}">
                                        @error('title4')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="description4" name="description4" value="{{ old('description4') }}">
                                        @error('description4')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
