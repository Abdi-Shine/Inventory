                        ...
                        <tbody>
                            @foreach ($sliders as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit_slider', $item->id) }}" class="btn btn-success btn-sm" title="Edit"><i class="fa-solid fa-pen"></i></a>
                                        <a href="{{ route('delete_slider', $item->id) }}" class="btn btn-danger btn-sm" id="delete" title="Delete"><i class="fa-solid fa-trash"></i></a>
