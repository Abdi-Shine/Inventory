    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="title" id="example-text-input" value="{{ $client->title }}">
                </div>
            </div>
            <!-- end row -->
           ...
           <input name="image" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ asset($client->image) }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Update Client Data">
            </form>
