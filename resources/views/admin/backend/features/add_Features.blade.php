...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('store.features') }}" enctype="multipart/form-data">
                @csrf
            ...
            <!-- end row -->
             ...
             <div class="row mb-3">
                ...
                <div class="col-sm-10">
           <input name="icon" class="form-control" type="text" id="icon">
                </div>
            </div>
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Feature Data">
            </form>
